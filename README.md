...
[下载知乎简洁版 v1.28 APK](知乎简洁版-v1.28.apk)
...
```text
537F6C8230CD2A81C73403D06594FECBA3BBCE59572430369555E9C6778DA002
```

## v1.28 修复

- 问题标题与正文按屏幕宽度换行，清除问题详情的固定高度
- 问题操作栏恢复横向排列，按钮文字不再逐字折行
- 问题页顶部搜索框随屏幕宽度收缩，避免右侧溢出
